...
interface WorldLayerDebugOverlayProps {
  enabled?: boolean;
}
...
export function WorldLayerDebugOverlay({ enabled }: WorldLayerDebugOverlayProps) {
  ...
  return (
    <svg className="pointer-events-none absolute inset-0 z-40 h-full w-full overflow-visible">
      ...
      {controller.validationIssues.map((issue, index) => {
